...
- **百度网盘**: [https://pan.baidu.com/s/1Z8gALExHbSeKxgvnNDEBlA?pwd=nrtr](https://pan.baidu.com/s/1Z8gALExHbSeKxgvnNDEBlA?pwd=nrtr)
...
| :------- | :--------- | :------- | :----------------------------------------------------- | :--------------- |
| `v1.0.3` | 2026-03-09 | **新增** | 新增“量子-大一下”的专业书籍。                          | 每学期才发布书单 |
...
如果您是任何资源的版权方并认为本仓库的内容侵犯了您的权益，或者在使用过程中**发现书籍内容有误、文件损坏或任何其他问题**，请通过以下方式联系我们：

- 邮箱：[gdutelc@gmail.com]
- 问题反馈：通过GitHub Issues提交版权移除请求

收您的反馈后，我们将在24小时内核实并处理。
